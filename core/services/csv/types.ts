export interface CsvFileHandle {
  ...
  _file?: File; // Fallback for browsers without File System Access API
  _cachedContent?: string; // Cached content for dropped files (File objects can't be serialized)
}
